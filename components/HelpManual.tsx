          ...
          <ScrollView contentContainerStyle={{ padding: 16, paddingTop: 4, gap: 8 }} showsVerticalScrollIndicator={false}>
            ...
            <Card style={{ borderColor: t.success, borderWidth: 1 }}>
              <Section emoji="✍️" title="주간 확인·서명 & 내 기록 잠금 (이력 탭)">
                <Step><Text style={{ fontWeight: '700' }}>이미 지난 주</Text>의 근무기록을 확인하고 <Text style={{ fontWeight: '700' }}>로그인 비밀번호를 입력해 서명</Text>하세요(본인 확인). 진행 중인 <Text style={{ fontWeight: '700' }}>이번 주는 주가 끝난 뒤</Text>에 서명할 수 있습니다.</Step>
                <Step>매주 월요일 출퇴근 화면에서 <Text style={{ fontWeight: '700' }}>서명 안 한 주가 있으면 알림 팝업</Text>이 뜹니다.</Step>
